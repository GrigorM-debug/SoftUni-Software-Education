...
namespace BookingApp.Core
{
    public class Controller : IController
    {
        ...
        {
            var exist = this.hotels.All().FirstOrDefault(x=> x.FullName== hotelName);
        ...
        {
            var hotel = this.hotels.All().FirstOrDefault(x=> x.FullName== hotelName);
        ...
        public string SetRoomPrices(string hotelName, string roomTypeName, double price)
        {
            ...
            var room = hotel.Rooms.All().FirstOrDefault(x => x.GetType().Name == roomTypeName);
